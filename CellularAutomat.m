classdef CellularAutomat < IIteratedObject & handle % объект клеточного автомата
    ...
    properties
        ...
        % массив всех ячеек на поле
        Cells
        % тип окрестности
        Neighborhood
        % ребро поля
        N double {mustBePositive, mustBeInteger}
        % массив весов всех соседей и центральной ячейки
        Weights(1, :) double = [1, 1, 1, 1, 1]
        % постоянная строка с общим видом итерированной функции
    ...
    methods
        ...
        % установка длины ребра поля и типа окрестности
        ...
        % создание поля клеточного автомата
        ...
        % генерация массива гексагональных ячеек для КА
        ...
        % генерация массива квадратных ячеек для КА
        ...
        % задание начальных состояний ячеек КА
        ...
        % задание начальных состояний ячеек КА при помощи диапазона значений выбранной функции с заданными параметрами
        ...
        % генерация начальных состояний ячеек КА при помощи диапазона значений выбранной функции с заданными параметрами
        ...
        % задание начальных состояний ячеек КА путем чтения файла (.txt,.xlsx)
        ...
        % обновление состояний соседей для каждой ячейки после итерации
        ...
        % вставка параметров конкретной ячейки в итерированную функцию (значения соседей и их число)
        ...
        % проверка: продолжать ли текущий этап моделирования
